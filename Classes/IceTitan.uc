...
// SMPTitan. by satore
//=============================================================================
class IceTitan extends SMPTitan;
event PostBeginPlay()
{
    Super.PostBeginPlay();
    MyAmmo.ProjectileClass = class'AeIceTitansBigRock';
}
...
function SpawnRock()
{
    ...
    if (FRand() < 0.4)
    {
        Proj=Spawn(class'AeIceTitansBoulder',,,FireStart,FireRotation);
        if(Proj!=none)
        {
...
defaultproperties
{
     MonsterName="Ae][ElementalIce"
     Skins(0)=Texture'tk_AeTitansV5.Skins.BlueTitan'
     Skins(1)=Texture'tk_AeTitansV5.Skins.BlueTitan'
}
